...
class DataCollectionPage extends StatefulWidget {
  DataCollectionPage({Key? key, required this.title}) : super(key: key);
...
class DataCollectionPageState extends State<DataCollectionPage> {
  ...
  PuttingMetrics _currMetrics = PuttingMetrics(
                                  impact: 0.0,
                  ...
                  onPressed: () {
                    _ble.connect(
                      ...
                      onPreSwingReceived: (metricsBytes) {
                        setState(() {
                          _currMetrics.updateMetrics(metricsBytes);
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      Text(
                        "Impact: ${_currMetrics.impact.toStringAsFixed(2)}",
                        style: TextStyle(fontSize: 14),
                        textAlign: TextAlign.center,
                      ),
                      const SizedBox(height: 4),
                      Text(
                        "Center offset of hole before swing: ${_currMetrics.followThroughDeg.toStringAsFixed(2)}",
                        style: TextStyle(fontSize: 14),
                        textAlign: TextAlign.center,
                      ),
                      const SizedBox(height: 4),
                      Text(
                        "Horizontal distance between ball and hole after swing: ${_currMetrics.tempo.toStringAsFixed(2)}",
                        style: TextStyle(fontSize: 14),
                        textAlign: TextAlign.center,
                      ),
                      const SizedBox(height: 4),
                      Text(
                        "Vertical distance between ball and hole after swing: ${_currMetrics.stability.toStringAsFixed(2)}",
                        style: TextStyle(fontSize: 14),
                        textAlign: TextAlign.center,
                      ),
                      const SizedBox(height: 4),
                      Text(
                        "Force of swing: ${_currMetrics.straightness.toStringAsFixed(2)}",
                        style: TextStyle(fontSize: 14),
                        textAlign: TextAlign.center,
                      ),
                      const SizedBox(height: 4),
                      Text(
                        "Angle of putter before swing: ${_currMetrics.direction.toStringAsFixed(2)}",
                        style: TextStyle(fontSize: 14),
                        textAlign: TextAlign.center,
                      ),
                      const SizedBox(height: 4),
